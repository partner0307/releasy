...
const mock = [
  {
    ...
    image: (
      <>
        <Image src={ClientImage} style={{ width: '100%', height: '100%' }} alt='client' />
      </>
    ),
  },
  {
    ...
    image: (
      <Image src={DesignImage} style={{ width: '100%', height: '100%' }} alt='design' />
    ),
  },
  {
    ...
    image: (
      <>
        <Image src={ApprovalImage} style={{ width: '100%', height: '100% !important' }} alt='approval' />
      </>
    ),
  },
  {
    ...
    image: (
      <>
        <Image src={AgileImage} style={{ width: '100%', height: '100%' }} alt='priciple' />
      </>
    ),
  },
];
